...
from unet.submodules import TimeEmbedding, DownBlock, Downsample, MiddleBlock, UpBlock, Upsample, Swish
        ...
        * `n_blocks` is the number of `UpDownBlocks` at each resolution
        ...
        for i in range(n_resolutions):
            ...
            for _ in range(n_blocks):
                down.append(DownBlock(in_channels, out_channels, time_channels))
